...
public class practica extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(176, 97, 42));

        panel1.setBackground(new java.awt.Color(254, 187, 70));

        jLabel1.setBackground(new java.awt.Color(36, 137, 188));
        jLabel1.setFont(new java.awt.Font("URW Gothic", 0, 48)); // NOI18N
